  ...
  return (
    <div className="flex items-center gap-2 px-4 py-1.5" aria-live="polite" role="status">
      <div className="flex items-center gap-1">
        <span className="w-2 h-2 rounded-full bg-brand-gradient animate-bounce" style={{ animationDelay: "0ms" }} />
        <span className="w-2 h-2 rounded-full bg-brand-gradient animate-bounce" style={{ animationDelay: "150ms" }} />
        <span className="w-2 h-2 rounded-full bg-brand-gradient animate-bounce" style={{ animationDelay: "300ms" }} />
      </div>
